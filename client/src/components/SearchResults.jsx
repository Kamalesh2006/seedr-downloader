      ...
      <div className="px-5 py-4 border-b border-[#1E293B] bg-[#111927] flex items-center justify-between">
        <div>
          <h3 className="text-base font-bold text-white flex items-center gap-2">
            Search Results
            <span className="text-xs bg-[#090F1C] text-[#00DF81] px-2.5 py-0.5 rounded-full border border-[#1E293B]">
          ...
          return (
            <div key={`m-${idx}`} className={`p-4 space-y-2.5 ${isOversized ? 'bg-red-950/10' : ''}`}>
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                <span className="px-2 py-0.5 rounded bg-[#090F1C] text-slate-400 font-mono border border-[#1E293B]">
                  {result.provider}
                </span>
                ...
                <div className="flex items-center gap-2 ml-auto">
                  <span className="inline-flex items-center gap-0.5 text-xs font-semibold text-[#00DF81]">
